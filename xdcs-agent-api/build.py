from pybuilder.core import use_plugin, init, depends, task, dependents
...
def initialize(project):
    ...
    project.set_property('package_command', 'python3 -m grpc_tools.protoc -I=src/main/proto --python_out=./target/generated-sources/protobuf/python --grpc_python_out=./target/generated-sources/protobuf/grpc-python ./src/main/proto/agent_api.proto')
